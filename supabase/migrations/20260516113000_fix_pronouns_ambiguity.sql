...
[
  ...
  {"type":"grammar_pattern","topic":"pronouns","english":"I have a book. This is ___ book. Correct: my","russian":"Контекст: у меня есть книга. Пропуск: This is my book.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"I have a book. This is ___ book.","example_ru":"my"},
  {"type":"grammar_pattern","topic":"pronouns","english":"You have a pencil. This is ___ pencil. Correct: your","russian":"Контекст: у тебя есть карандаш. Пропуск: This is your pencil.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"You have a pencil. This is ___ pencil.","example_ru":"your"},
  {"type":"grammar_pattern","topic":"pronouns","english":"Tom has a dog. This is ___ dog. Correct: his","russian":"Контекст: у Тома есть собака. Пропуск: This is his dog.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"Tom has a dog. This is ___ dog.","example_ru":"his"},
  {"type":"grammar_pattern","topic":"pronouns","english":"Anna has a bag. This is ___ bag. Correct: her","russian":"Контекст: у Анны есть сумка. Пропуск: This is her bag.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"Anna has a bag. This is ___ bag.","example_ru":"her"},
  {"type":"grammar_pattern","topic":"pronouns","english":"They have toys. These are ___ toys. Correct: their","russian":"Контекст: у них есть игрушки. Пропуск: These are their toys.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"They have toys. These are ___ toys.","example_ru":"their"},
  {"type":"grammar_pattern","topic":"pronouns","english":"We have a classroom. This is ___ classroom. Correct: our","russian":"Контекст: у нас есть класс. Пропуск: This is our classroom.","tags":["possessive_adjectives","fill_the_gap","context"],"example_en":"We have a classroom. This is ___ classroom.","example_ru":"our"},
...
[
  ...
  },
  {
    ...
    "exercise_templates":[{"type":"fill_the_gap","context":"I have a book.","prompt":"This is ___ book.","correctAnswer":"my"},{"type":"fill_the_gap","context":"Anna has a bag.","prompt":"This is ___ bag.","correctAnswer":"her"},{"type":"question_form","statement":"This is your book.","correctAnswer":"Is this your book?"},{"type":"short_answer","context":"I have a book.","question":"Whose book is this?","correctAnswer":"It is my book."}]
  }
]
$json$::jsonb;
  v_texts jsonb := $json$
...
begin
  ...
  update public.cards
  set status = 'archived'::public.card_status
  where family_id = v_family
    and course_id = v_course
    and source_id = v_source
    and type = 'grammar_pattern'::public.card_type
    and status <> 'archived'::public.card_status
    and tags && array['possessive_adjectives', 'fill_the_gap']::text[]
    and english in (
  ...
  get diagnostics v_archived_cards = row_count;
  ...
  return jsonb_build_object(
    ...
    'archived_cards', v_archived_cards,
